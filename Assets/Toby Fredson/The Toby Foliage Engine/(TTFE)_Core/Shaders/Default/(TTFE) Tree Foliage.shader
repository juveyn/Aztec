	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 bakedGI2874 = ASEBakedGI( float3( 0,0,0 ), float3( 0,0,0 ), float2( 0,0 ), float2( 0,0 ) );
				...
				#ifdef ASE_BAKEDGI
				surfaceDescription.BakedGI = bakedGI2874;
				#endif
				#ifdef ASE_BAKEDBACKGI
				surfaceDescription.BakedBackGI = ( float3( 0,0,0 ) * bakedGI2874 );
				#endif
